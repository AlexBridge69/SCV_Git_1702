...
У команды `git log` есть упрощённый вариант `git log --oneline`. Она так же выведет все коммиты, но без указания авторов и с более короткими номерами. В данном случае для выхода клавишу "Q" нажимать не надо.